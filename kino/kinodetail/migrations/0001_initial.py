    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio_ru', models.CharField(max_length=32, null=True)),
                ('bio_en', models.CharField(max_length=32, null=True)),
                ('bio_ky', models.CharField(max_length=32, null=True)),
                ('age', models.PositiveSmallIntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(blank=True, default='+996', max_length=128, null=True, region=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actor', models.ManyToManyField(to='kinodetail.actor')),
                ('country', models.ManyToManyField(to='kinodetail.country')),
                ('director', models.ManyToManyField(to='kinodetail.director')),
                ('genre', models.ManyToManyField(to='kinodetail.genre')),
            ],
        ),
        migrations.CreateModel(
            name='Moments',
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kinodetail.movie')),
            ],
        ),
        migrations.CreateModel(
            name='History',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kinodetail.favorite')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kinodetail.movie')),
            ],
        ),
        migrations.CreateModel(
